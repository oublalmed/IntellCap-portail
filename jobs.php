              ...
              <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" >
                <div class="contact_input_area">
                  <div class="row">
                    ...
                    <div class="col-12 col-lg-12">
                      <div class="form-group">
                        <select class="form-control" style="font-family: 'FontAwesome' , 'TATSanaChon';">
                    ...
                    <div class="col-12 col-lg-12">
                      <div class="form-group">
                        <textarea name="posts" rows="6" cols="60" placeholder=" Your motivation "></textarea>
                      </div>
                    </div>
                    <!-- Form Group -->
                    <!-- Button -->
                    <div class="col-12">
                      <button type="submit" class="btn btn-style btn-outline-primary" name="sinscrireBtn" style=" color: black;">Apply <i class="zmdi zmdi-long-arrow-right"></i></button>
                    </div>
                  </div>
                </div>
              </form>
